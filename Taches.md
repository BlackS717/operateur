...
## Modification base de donnee ```ETU 3893```

- [x] Modification de la base pour separer l'operateur du client
- [x] Modification de l'authentification pour separer les utilisateurs des operateurs

## Côté opérateur

### Gestion des opérateurs ```ETU 4316```
- [x] Ajouter la gestion de plusieurs opérateurs.
- [x] Configurer les préfixes valides pour chaque opérateur (ex. : 032, 031, 033, 037...).
- [x] Associer chaque préfixe à son opérateur.

### Gestion des frais ```ETU 3893```
...
- [x] Ne pas appliquer de frais de retrait pour les transferts vers les autres opérateurs.
...
- [x] Limiter l'envoi multiple aux destinataires appartenant au même opérateur.

## Backend

### API ```ETU 4316```
- [x] Adapter les API pour la gestion de plusieurs opérateurs.
...
- [X] Ajouter les validations pour empêcher un envoi multiple entre différents opérateurs.
